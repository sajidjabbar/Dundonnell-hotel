                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="amenities-box">
                                                ...
                                                <a href="javascript:void(0)"><i class="fa fa-wifi"
                                                        aria-hidden="true"></i>
                                                    Free WiFi</a>
                                        ...
                                        <div class="col-md-4">
                                            <div class="Popular-amenities">
                                                ...
                                                <a href="javascript:void(0)"><i
                                                        class="fas fa-glass-martini-alt"></i>bar</a>
                                                <a href="javascript:void(0)"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-9 p-0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-8">
                                                    <div class="para-fivestar">
                                                        <p>Fully pre-paid once booking has been received, non-refundable
                                                            and
                                                            non-transferable. A credit or debit card is required to
                                                            guarantee your
                                                            booking, the full cost of the stay will be taken at the time
                                                            of
                                                            booking.
                                                            Please note all guests must present a debit/credit card on
                                                            check
                                                            in to
                                                            validate..... <span> read more</span>
                                                        </p>
                                    ...
                                    <div class="boking-slider-wrappers1">
                                        <div class="row">
                                            ...
                                            <div class="customize-heading">
                                                ...
                                                <p>Fully pre-paid once booking has been received, non-refundable and
                                                    non-transferable. A credit or debit
                                                    card is required to guarantee your booking, the full cost of the
                                                    stay
                                                    will
                                                    be taken at the time of booking. Please note all
                                                    guests must present a debit/credit card on check in to validate.....
                                                    <a href="javascript:void(0)" class="custom-read"> read more</a>
                                                </p>
                                            </div>
                                            <div class="discount-box">
                                                <div class="col-md-7">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <div class="information-heading">
                                                            ...
                                                            <h5 class="field">Fields marked ( * ) are mandatory.</h5>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-7 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="exampleInputPassword1" placeholder="Line 1">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5 ">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Card Number *</label>
                                                                <input type="number" class="form-control"
                                                                    id="exampleInputPassword1" placeholder="Postcode">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="checkbook-btn">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label for="html">Guest information is different to
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="checkbook-btn">
                                                                <div class="form-group">
                                                                    <input type="checkbox" id="html">
                                                                    <label for="html">Please sign me up to the
                                                                        newsletter.
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                                            <div class="information-heading">
                                                                ...
                                                                <h5 class="field">A valid credit or debit card is
                                                                    required
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="checkbook-btn">
                                                                <div class="form-group">
                                                                    <input type="checkbox" id="html">
                                                                    <label for="html">Cardholder information is
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="visa-banker">
                                                                <a href=""><img src="./img/icon-visa.png" alt=""></a>
                                                                <a href=""><img src="./img/icon-visa1.png" alt=""></a>
                                                                <a href=""><img src="./img/icon-visa2.png" alt=""></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="term-condition-content">
                                                    ...
                                                    <div class="para-wrapper-term">
                                                        ...
                                                        <p>Pre-Paid Rates - Fully pre-paid once booking has been
                                                            received, non-refundable and non-transferable. Please
                                                            present your credit/debit card on check in to validate the
                                                            booking. Please note all guests must present a debit/credit
                                                            card on check in to validate all bookings and a part payment
                                                            will be taken for authorisation and security purposes.
                                                        </p>
                                                    </div>
                                                    <div class="para-wrapper-term">
                                                        <h6>Hotel terms
                                                        </h6>
                                                        <p>Book Now Rates- Free cancellation charge if a booking is
                                                            cancelled before two day(s) before the date of arrival.
                                                            Where cancellation is made outside of the above terms the
                                                            guest will be charged the full amount for the first night's
                                                            accommodation. A credit or debit card is required to
                                                            guarantee your booking, the full accommodation will be
                                                            charged at check in.Please note all guests must present a
                                                            debit/credit card on check in to validate all bookings and a
                                                            part payment will be taken for authorisation and security
                                                            purposes. Rates are only based on either 1 or 2 people as
                                                            specified.
                                                    ...
                                                    <div class="para-wrapper-term">
                                                        ...
                                                        <p>Flexible Rates: Bed & Breakfast, Book Now & Pay Later
                                                        </p>
                                                        <p>Book Now Rates- Free cancellation charge if a booking is
                                                            cancelled before two day(s) before the date of arrival.
                                                            Where cancellation is made outside of the above terms the
                                                            ...
                                                            guarantee your booking, the full accommodation will be
                                                            charged at check in. Please note all guests must present a
                                                            debit/credit card on check in to validate all bookings and
                                                            part payment will be taken for authorisation and security
                                                            purposes. Rates are only based on either 1 or 2 people as
                                                            specified.</p>
                                                    </div>
