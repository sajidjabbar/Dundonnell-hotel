...
<section class="wester-sec">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="slide-up">
                    <a href="#"><img src="img/slide-down.png" alt="" class="img-fluid"></a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary news-btn"
                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    <div class="form-group date-control">
                                        ...
                                        <input type="email" class="form-control book-control" id="inputdate"
                                            placeholder="6-02-2022">
                                ...
                                <div class="col-md-2 p-0">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control book-control" id="inputtime4"
                                            placeholder="18:00 am">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group ">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="password" class="form-control book-control" id="inputname"
